...
ActiveRecord::Schema.define(version: 2019_04_17_083002) do
  ...
  create_table "api_manages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "api_name"
    t.integer "manage"
  ...
  create_table "apps", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "app_name"
    t.string "app_id"
    t.string "app_key"
    t.string "app_secret"
  ...
  create_table "category_formula_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "category_formulas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "category_number"
    t.string "formula"
    t.integer "top_limit"
  ...
  create_table "category_requests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id_code"
    t.string "app_id"
    t.bigint "user_id"
  ...
  create_table "resolution_requests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id_code"
    t.string "plain_code"
    t.string "app_id"
    t.bigint "user_id"
